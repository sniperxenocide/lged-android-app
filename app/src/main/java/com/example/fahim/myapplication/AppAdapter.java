...
public class AppAdapter extends ArrayAdapter<JSONObject> implements View.OnClickListener

{
    ...
    public AppAdapter(ArrayList<JSONObject> data, Context context, MainActivity ma)
    {
    ...
    public void detailButtonFunction(JSONObject o, int p)
    {
        ...
        try
        {
            ...
            i1.setText("Budget Type");
            x = o.getString("budget_type");
            if(x!="null") i2.setText(x);

            j1.setText("Project Name");
            x = o.getString("project_name");
            if(x!="null") j2.setText(x);

            k1.setText("Procurement Nature");
            x = o.getString("proc_nature_value");
            if(x!="null") k2.setText(x);

            l1.setText("Type of Emergency");
            x = o.getString("type_of_emergency_value");
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        final JSONObject app = getItem(position);
        final AppAdapter.ViewHolder viewHolder;
        ...
        try {
            String x = "";
            if (app.getString("office_name") != "null") x = app.getString("office_name");
            viewHolder.t_name.setText(x);

            x="";
            if (app.getString("type") != "null") x = app.getString("type");
            if (app.getString("financial_year") != "null") x = x+ "\n"+ app.getString("financial_year");
        ...
        viewHolder.detailButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                detailButtonFunction(app,position);
            }
        });
